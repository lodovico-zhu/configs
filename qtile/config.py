...
keys = [
    ...
    Key([alt, "control"], "l",lazy.spawn("xtrlock")),
    ...
    # start specific apps
    Key([mod], "0",              lazy.spawn("google-chrome")),
...
def startup():
    ...
    execute_once("xrandr --output VGA-1-2 --off")
    execute_once("xrandr --output VGA-1-1 --off")
    execute_once("nm-applet")
    execute_once("xcompmgr")
    execute_once("ibus-daemon --xim")
    execute_once("hsetroot -fill /home/zhuzhen/图片/bg.jpg")
